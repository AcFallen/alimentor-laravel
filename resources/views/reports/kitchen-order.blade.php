...
<body>
    ...
    <div class="header">
        ...
        <div class="report-title">ORDEN DE COCINA</div>
    </div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 22%;">Total por unidad (aprox)</th>
        ...
        <tbody>
            @foreach ($categories as $category)
                ...
                <tr class="subtotal-row">
                    <td colspan="4" style="text-align: right;">Subtotal {{ $category['name'] }}:</td>
            ...
            <tr class="grand-total">
                <td colspan="4" style="text-align: right;">COSTO TOTAL PLANIFICACI&Oacute;N</td>
